    ...
    <>
      ...
      >
        <SwiperSlide className={style.swiper}>
            ...
            <p className="mt-3">Lorem ipsum, dolor sit amet consectetur adipisicing elit. Laudantium officiis provident vitae, doloribus eaque saepe </p>
        </SwiperSlide>
        <SwiperSlide  className={style.swiper}>
